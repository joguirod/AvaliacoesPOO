package Avaliacao02.questao12.Entidades;
...
public class PostagemAvancada extends Postagem {
    ...
    public PostagemAvancada(int id, String texto, Perfil perfil, int curtidas, int descurtidas, LocalDate data
            , List<String> hashtags, int visualizacoesRestantes) {
        super(id, texto, perfil, curtidas, descurtidas, data);
