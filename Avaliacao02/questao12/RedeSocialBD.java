...
import Avaliacao02.questao12.Repositorios.RepositorioDePerfisBD;
import Avaliacao02.questao12.Repositorios.RepositorioDePostagensBD;
...
public class RedeSocialBD implements IRedeSocial {
    ...
    public Postagem exibirPostagemMaisCurtida() {
        ...
        if (postagemMaisCurtida instanceof PostagemAvancada) {
            ...
            repositorioDePostagens.atualizarPostagemNoBD(postagemMaisCurtida, "visualizacoes_restantes",
                    ((PostagemAvancada) postagemMaisCurtida).getVisualizacoesRestantes());
        }
    ...
    public Postagem obterPostagemMaisDescurtida() {
        ...
        if (postagemMaisDescurtida instanceof PostagemAvancada) {
            ((PostagemAvancada) postagemMaisDescurtida).decrementarVisualizacoes();
                repositorioDePostagens.atualizarPostagemNoBD(postagemMaisDescurtida, "visualizacoes_restantes",
                        ((PostagemAvancada) postagemMaisDescurtida).getVisualizacoesRestantes());
