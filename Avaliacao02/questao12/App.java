...
public class App {
        ...
        do {
            ...
            try{
                ...
                if(e instanceof RuntimeException){
                    System.out.println("Contate um adminstrador. Erro no sistema.");
                }
            } finally {
    ...
    public static void salvarPerfisEmArquivo() throws IOException {
        File filePerfis = new File("Avaliacao02\\questao12\\perfis.txt");
    ...
    public static void salvarPostagensEmArquivo() throws IOException {
        File filePostagens = new File("Avaliacao02\\questao12\\postagens.txt");
